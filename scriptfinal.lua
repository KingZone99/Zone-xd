...
-- FIX ESP BARANG SPESIFIK - VERSI FINAL
...
-- ==================================================
-- DETEKSI BARANG (FIX - UDH GW TAMBAHIN SEMUA!)
-- ==================================================
local function GetItems()
    ...
    for _,v in pairs(Workspace:GetDescendants())do
        if v:IsA("Part")and v.Parent~=LocalPlayer.Character then
            ...
            -- FILTER BARANG - UDH GW TAMBAHIN SEMUA YANG LU SEBUTIN!
            if 
               -- BARANG LAMA (tetep dipertahankan)
...
-- ==================================================
-- DETEKSI POCONG (TAMBAHIN VARIAN NAMA)
-- ==================================================
    ...
    for _,v in pairs(Workspace:GetDescendants())do
        if v:IsA("Model")and(v:FindFirstChild("Humanoid")or v:FindFirstChild("Body"))then
            ...
            if n:find("pocong")or n:find("hantu")or n:find("ghost")or
               ...
               n:find("beliau")or n:find("penampakan")or n:find("makhluk")or
               n:find("setan")or n:find("demon")or n:find("jin")or n:find("jinn")
            then
                table.insert(poc,v)
            end
        end
...
local function UpdateESP()
    ...
    -- NOTIF JUMLAH BARANG (biar tau ke detect apa engga)
...
print([[
╔══════════════════════════════════════════════════════════════╗
║   ZONE XD - FIX ESP BARANG SPESIFIK                         ║
╠══════════════════════════════════════════════════════════════╣
