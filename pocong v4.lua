...
-- POCONG V3 - FIX ESP BARANG SPESIFIK - VERSI FINAL LENGKAP
...
-- ==================================================
CreateMenu()
Notif("ZONE XD","POCONG V3 LOADED! Tekan M",3)
