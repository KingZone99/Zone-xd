...
-- ==================================================
-- ESP FUNCTION (BAGIAN YANG KEPOTONG UDH GW SAMBUNG)
-- ==================================================
...
local function IsItem(n)
    return 
           ...
           n:find("kartu")or n:find("card")or n:find("id")or
           n:find("papan")or n:find("klip")or n:find("clipboard")or
           n:find("rekam")or n:find("medis")or n:find("medical")or
           n:find("pickup")or n:find("item")or n:find("collect")
end

local function IsPocong(n)
    return n:find("pocong")or n:find("hantu")or n:find("ghost")or
           n:find("setan")or n:find("demon")or n:find("kunti")
end
