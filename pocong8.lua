...
-- POCONG V8 - SAFETY MODE + ESP BAHASA INDONESIA (LENGKAP)
...
-- ==================================================
-- DETEKSI BARANG (BAHASA INDONESIA 100% - LENGKAP)
-- ==================================================
local function GetItems()
    ...
    for _,v in pairs(Workspace:GetDescendants())do
        if v:IsA("Part")and v.Parent~=LocalPlayer.Character then
            ...
            -- FILTER BAHASA INDONESIA SUPER LENGKAP
            if 
               -- Kacamata
               n:find("kacamata")or n:find("kaca mata")or n:find("kacamata baca")or n:find("kacamata hitam")or
               n:find("kacamata renang")or n:find("kacamata safety")or

               -- Dompet
               n:find("dompet")or n:find("dompet kulit")or n:find("dompet kain")or n:find("dompet pria")or
               n:find("dompet wanita")or n:find("dompet kecil")or n:find("dompet besar")or

               -- Jam Tangan
               n:find("jam")or n:find("jam tangan")or n:find("arloji")or n:find("jam tangan pria")or 
               n:find("jam tangan wanita")or n:find("jam dinding")or n:find("jam meja")or

               -- Pena Merah
               n:find("pena merah")or n:find("pulpen merah")or n:find("bolpen merah")or
               n:find("pena")and n:find("merah")or n:find("pulpen")and n:find("merah")or

               -- Kartu ID
               n:find("kartu id")or n:find("kartu identitas")or n:find("ktp")or n:find("kartu mahasiswa")or 
               n:find("kartu pelajar")or n:find("kartu karyawan")or n:find("id card")or

               -- Papan Klip
               n:find("papan klip")or n:find("klip board")or n:find("papan catatan")or 
               n:find("papan tulis kecil")or n:find("clipboard")or

               -- Rekam Medis
               n:find("rekam medis a")or n:find("rekam medis b")or n:find("rekam medis c")or
               n:find("rekam medis")or n:find("berkas medis")or n:find("catatan medis")or
               n:find("dokumen medis")or n:find("file medis")or

               -- Barang umum (fallback)
               n:find("kunci")or n:find("obat")or n:find("buku")or n:find("surat")or
               n:find("uang")or n:find("koin")or n:find("kertas")
            then
    ...
    for _,p in pairs(pocongs)do
        if p.PrimaryPart then
            ...
            if dist<Settings.SafetyRadius then
                ...
                safePos=Vector3.new(safePos.X, 5, safePos.Z)
