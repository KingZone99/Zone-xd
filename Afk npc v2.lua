-- AFK NPC DENGAN MENU INTERAKTIF + AUTO CHAT + VARIASI TEKS + MINIMIZE
...
tableMenu.Size = UDim2.new(1, 0, 0, 250)  -- Tinggi normal 250
...
tableMenu.ClipsDescendants = true  -- Biar kontennya ke cut kalo dikecilin
...
minimizeBtn.Text = "🔼"  -- Awalnya 🔼 karena table kebuka
...
-- FUNGSI CHAT (30 DETIK SEKALI - DENGAN VARIASI)
...
print([[
╔══════════════════════════════════════════════════════════════╗
║   🔥 ZONE XD - THE BEST AFK V3 🔥                            ║
║   ✅ MINIMIZE TABLE (BISA DICILKIN)                          ║
║   ✅ KARAKTER GERAK + VARIASI CHAT                           ║
║   👑 COPYRIGHT: APIS (USER 01) - ZONE XD V1                  ║
╚══════════════════════════════════════════════════════════════╝
]])