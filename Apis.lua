...
-- ==================================================
-- DETEKSI BARANG (LENGKAP - BAGIAN YANG KEPOTONG)
-- ==================================================
...
CreateSmallMenu()
CreateBigMenu()
Notif("ZONE XD","APIS V7 LOADED! Tekan M",3)
...
print([[
╔══════════════════════════════════════════════════════════════╗
║   🔥 ZONE XD - APIS.LUA (POCONG V7) 🔥                       ║
║   ✅ MENU COLLAPSIBLE (LOGO M + TABEL BESAR)                 ║
║   ✅ FITUR LENGKAP (ESP, TELEPORT, AUTO COLLECT, DLL)        ║
║   ✅ BARANG: Kacamata, Dompet, Jam, Pena, Kartu, Rekam Medis ║
║   👑 COPYRIGHT: APIS (USER 01) - ZONE XD V1                  ║
╚══════════════════════════════════════════════════════════════╝
]])